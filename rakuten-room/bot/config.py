...
PERSONA_NG_KEYWORDS = [
    ...
    "喪服", "葬儀", "仏壇", "数珠",
    # ペルソナ違和感あり
    # Codex 11回目 #4 反映: 「工具」単独は「工具不要」等 false positive 大 → より具体的に
    "釣り具", "ゴルフクラブ", "電動工具", "インパクトドライバー",
]

# タイトル/コメントに含まれる場合 boost (ペルソナ一致・優先)
PERSONA_BOOST_KEYWORDS = [
    "ベビー", "赤ちゃん", "新生児", "0歳", "1歳", "幼児", "乳児",
...
PERSONA_DEPRIORITIZED_GENRES = ["car", "outdoor", "pet", "garden", "sports"]
