...
set BOT_HEADLESS=1
python rakuten-room\bot\scripts\follow_via_seeds.py --target 60 --duration-min 13 >> "C:\Users\infoa\Documents\solarworks-ai\ops\scheduler\logs\windows_task_follow_host.log" 2>&1
exit /b %errorlevel%
