...
echo [STEP2] copy code (vm_v6 share folder 経由)
...
echo [STEP5] copy 4 chrome profiles (10-20min) via vm_data share
...
REM 完了 marker file を vm_v6 share に書く (HOST 側で完了検知)
